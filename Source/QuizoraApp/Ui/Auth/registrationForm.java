...
public class registrationForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        registrationPanelLayout.setHorizontalGroup(registrationPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(40).addComponent(brandLabel, 420, 420, 420).addGap(0, 40, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(40).addComponent(titleLabel, 420, 420, 420).addGap(0, 40, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(40).addComponent(subtitleLabel, 420, 420, 420).addGap(0, 40, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(40).addComponent(fullNameLabel, 202, 202, 202).addGap(0, 258, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(40).addComponent(fullNameField, 202, 202, 202).addGap(0, 258, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(258).addComponent(usernameLabel, 202, 202, 202).addGap(0, 40, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(258).addComponent(usernameField, 202, 202, 202).addGap(0, 40, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(40).addComponent(emailLabel, 420, 420, 420).addGap(0, 40, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(40).addComponent(emailField, 420, 420, 420).addGap(0, 40, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(40).addComponent(passwordLabel, 202, 202, 202).addGap(0, 258, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(40).addComponent(passwordField, 202, 202, 202).addGap(0, 258, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(258).addComponent(confirmPasswordLabel, 202, 202, 202).addGap(0, 40, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(258).addComponent(confirmPasswordField, 202, 202, 202).addGap(0, 40, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(40).addComponent(registerButton, 420, 420, 420).addGap(0, 40, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(40).addComponent(backToLoginButton, 420, 420, 420).addGap(0, 40, Short.MAX_VALUE))
        );
        registrationPanelLayout.setVerticalGroup(registrationPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(24).addComponent(brandLabel, 22, 22, 22).addGap(0, 454, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(54).addComponent(titleLabel, 40, 40, 40).addGap(0, 406, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(97).addComponent(subtitleLabel, 22, 22, 22).addGap(0, 381, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(144).addComponent(fullNameLabel, 20, 20, 20).addGap(0, 336, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(170).addComponent(fullNameField, 42, 42, 42).addGap(0, 288, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(144).addComponent(usernameLabel, 20, 20, 20).addGap(0, 336, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(170).addComponent(usernameField, 42, 42, 42).addGap(0, 288, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(227).addComponent(emailLabel, 20, 20, 20).addGap(0, 253, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(253).addComponent(emailField, 42, 42, 42).addGap(0, 205, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(310).addComponent(passwordLabel, 20, 20, 20).addGap(0, 170, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(336).addComponent(passwordField, 42, 42, 42).addGap(0, 122, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(310).addComponent(confirmPasswordLabel, 20, 20, 20).addGap(0, 170, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(336).addComponent(confirmPasswordField, 42, 42, 42).addGap(0, 122, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(400).addComponent(registerButton, 44, 44, 44).addGap(0, 56, Short.MAX_VALUE))
            .addGroup(registrationPanelLayout.createSequentialGroup().addGap(452).addComponent(backToLoginButton, 32, 32, 32).addGap(0, 16, Short.MAX_VALUE))
        );

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup().addComponent(registrationPanel, 500, 500, 500).addComponent(panelImageLabel, 500, 500, 500)));
        layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(registrationPanel, 500, 500, 500).addComponent(panelImageLabel, 500, 500, 500));
